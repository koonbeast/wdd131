const hikes1 = ["teton", "Goldbug Hotsprings", "r mountain", "Teton", "R Mountain", "Hisee", "HISEE", "GZ", "Gz"]

const ages = [33, -99, 8, 40, 20, -1, 7, 121]

const people = [{name: "Steve"}, {name: "Bob"}, {name: "Rob"}]

// sort() doesn't know what to do other than default alphabetical, so we make our own sort function
// compares 2 parameters
function sortPeople(a, b) {
// we need to return a value of either -1, 0, or 1
// -1, 0, 1 means less than, equal to, or greater than
